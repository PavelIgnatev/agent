...
TARGET_URL = "https://t.me/ignatevPavel"


async def make_request_with_socks5(session):
...
async def main():
    connector = ProxyConnector.from_url(
        f"socks5://r2endsadsa:231321321@host.docker.internal:9050",
        limit=0,
        ssl=False,
    )

    async with aiohttp.ClientSession(connector=connector) as session:
        tasks = [make_request_with_socks5(session) for _ in range(25)]
